...
router.post("/send", (req, res) => {
    const output = `
      ...
      <ul>  
        ...
        <li>Phone: ${req.body.positon}</li>
        <li>Phone: ${req.body.city}</li>
        <li>Phone: ${req.body.country}</li>
      </ul>
      <h3>Message</h3>
    ...
    let mailOptions = {
        from: '"Nodemailer Contact" labventure1@gmail.com', // sender address
        to: "shamiivan@gmai.com", // list of receivers
